                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NCliente.Insertar(this.txtNombre.Text.Trim().ToUpper(), this.txtApellidos.Text.ToUpper(),
                                                 this.cbSexo.Text.ToUpper(), dtFechaNacimiento.Value, cbTipoDocumento.Text.Trim().ToUpper(),
                                                 txtNumDocumento.Text, txtDireccion.Text.Trim().ToUpper(), txtTelefono.Text, txtEmail.Text.Trim().ToUpper());
                    }
                    else
                    {
                        rpta = NCliente.Editar(Convert.ToInt32(this.txtIdCliente.Text), this.txtNombre.Text.Trim().ToUpper(), this.txtApellidos.Text.ToUpper(),
                                                 this.cbSexo.Text.ToUpper(), dtFechaNacimiento.Value, cbTipoDocumento.Text,
                                                 txtNumDocumento.Text, txtDireccion.Text.Trim().ToUpper(), txtTelefono.Text, txtEmail.Text.Trim().ToUpper());
                    }
                    if (rpta.Equals("OK"))
                    {
